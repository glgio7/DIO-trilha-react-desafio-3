...
import { Container, Title, Column, TitleLogin, SubtitleLogin, CriarText, Row, Wrapper, LastRow, Terms } from './styles';
...
const Register = () => {
    ...
    const onSubmit = async (formData) => {
        try{
            const {data} = await api.get(`/users?email=${formData.email}&senha=${formData.senha}&name=${formData.name}`);
